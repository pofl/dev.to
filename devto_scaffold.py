...
This script creates article.md in the given article directory with JSON
frontmatter and safe draft defaults.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create a local dev.to article file with JSON frontmatter.")
    parser.add_argument("article_dir", type=Path, help="article directory to create, such as articles/my-post")
...
def main() -> None:
    args = parse_args()
    slug = validate_slug(args.article_dir.name)
